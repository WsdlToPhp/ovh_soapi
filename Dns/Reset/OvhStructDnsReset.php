<?php
/**
 * File for class OvhStructDnsReset
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDnsReset originally named dnsReset
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDnsReset extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
