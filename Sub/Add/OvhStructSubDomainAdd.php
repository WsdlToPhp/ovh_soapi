<?php
/**
 * File for class OvhStructSubDomainAdd
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructSubDomainAdd originally named subDomainAdd
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructSubDomainAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $country;
	/**
	 * Constructor method for subDomainAdd
