<?php
/**
 * File for class OvhStructHostingAccessByNicResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructHostingAccessByNicResponse originally named hostingAccessByNicResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructHostingAccessByNicResponse extends OvhWsdlClass
{
	/**
	 * The return
