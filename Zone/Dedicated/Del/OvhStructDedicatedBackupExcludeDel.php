<?php
/**
 * File for class OvhStructDedicatedBackupExcludeDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedBackupExcludeDel originally named dedicatedBackupExcludeDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedBackupExcludeDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $exclude;
	/**
	 * Constructor method for dedicatedBackupExcludeDel
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_hostname
	 * @param string $_backupId
	 * @param string $_exclude
	 * @return OvhStructDedicatedBackupExcludeDel
	 */
	...
	/**
	 * Set exclude value
	 * @param string $_exclude the exclude
	 * @return string
	 */
