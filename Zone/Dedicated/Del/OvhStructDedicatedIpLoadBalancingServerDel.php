<?php
/**
 * File for class OvhStructDedicatedIpLoadBalancingServerDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedIpLoadBalancingServerDel originally named dedicatedIpLoadBalancingServerDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedIpLoadBalancingServerDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDedicatedIpLoadBalancingServerDel
	 */
