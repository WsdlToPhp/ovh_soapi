<?php
/**
 * File for class OvhStructDedicatedNetworkTrafficDetailsStruct
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedNetworkTrafficDetailsStruct originally named dedicatedNetworkTrafficDetailsStruct
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedNetworkTrafficDetailsStruct extends OvhWsdlClass
{
	/**
	 * The in
	 * @var string
