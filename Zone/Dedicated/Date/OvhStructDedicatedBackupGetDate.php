<?php
/**
 * File for class OvhStructDedicatedBackupGetDate
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedBackupGetDate originally named dedicatedBackupGetDate
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedBackupGetDate extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $backupId;
	/**
	 * Constructor method for dedicatedBackupGetDate
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_hostname
	 * @param string $_backupId
	 * @return OvhStructDedicatedBackupGetDate
	 */
