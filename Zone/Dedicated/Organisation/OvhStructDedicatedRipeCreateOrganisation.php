<?php
/**
 * File for class OvhStructDedicatedRipeCreateOrganisation
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedRipeCreateOrganisation originally named dedicatedRipeCreateOrganisation
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedRipeCreateOrganisation extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDedicatedRipeCreateOrganisation
	 */
