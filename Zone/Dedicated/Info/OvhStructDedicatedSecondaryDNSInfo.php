<?php
/**
 * File for class OvhStructDedicatedSecondaryDNSInfo
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedSecondaryDNSInfo originally named dedicatedSecondaryDNSInfo
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedSecondaryDNSInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_ip
	 * @return OvhStructDedicatedSecondaryDNSInfo
	 */
