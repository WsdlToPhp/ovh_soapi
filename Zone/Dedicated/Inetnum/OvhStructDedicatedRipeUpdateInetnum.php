<?php
/**
 * File for class OvhStructDedicatedRipeUpdateInetnum
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedRipeUpdateInetnum originally named dedicatedRipeUpdateInetnum
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedRipeUpdateInetnum extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDedicatedRipeUpdateInetnum
	 */
