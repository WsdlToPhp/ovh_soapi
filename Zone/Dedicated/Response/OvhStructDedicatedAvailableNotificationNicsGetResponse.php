<?php
/**
 * File for class OvhStructDedicatedAvailableNotificationNicsGetResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedAvailableNotificationNicsGetResponse originally named dedicatedAvailableNotificationNicsGetResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedAvailableNotificationNicsGetResponse extends OvhWsdlClass
{
	/**
	 * The return
