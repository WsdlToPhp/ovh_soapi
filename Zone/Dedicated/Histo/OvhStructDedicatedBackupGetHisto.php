<?php
/**
 * File for class OvhStructDedicatedBackupGetHisto
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedBackupGetHisto originally named dedicatedBackupGetHisto
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedBackupGetHisto extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $backupId;
	/**
	 * Constructor method for dedicatedBackupGetHisto
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_hostname
	 * @param string $_backupId
	 * @return OvhStructDedicatedBackupGetHisto
	 */
