<?php
/**
 * File for class OvhStructDedicatedMonitoringStatusUpdate
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedMonitoringStatusUpdate originally named dedicatedMonitoringStatusUpdate
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedMonitoringStatusUpdate extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDedicatedMonitoringStatusUpdate
	 */
