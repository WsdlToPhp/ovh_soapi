<?php
/**
 * File for class OvhStructDedicatedBackupExcludeAdd
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedBackupExcludeAdd originally named dedicatedBackupExcludeAdd
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedBackupExcludeAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDedicatedBackupExcludeAdd
	 */
