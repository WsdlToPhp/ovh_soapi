<?php
/**
 * File for class OvhStructDedicatedBackupGetFreePlanning
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedBackupGetFreePlanning originally named dedicatedBackupGetFreePlanning
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedBackupGetFreePlanning extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDedicatedBackupGetFreePlanning
	 */
