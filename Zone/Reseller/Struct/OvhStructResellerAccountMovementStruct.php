<?php
/**
 * File for class OvhStructResellerAccountMovementStruct
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructResellerAccountMovementStruct originally named resellerAccountMovementStruct
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructResellerAccountMovementStruct extends OvhWsdlClass
{
	/**
	 * The amount
	 * @var int
