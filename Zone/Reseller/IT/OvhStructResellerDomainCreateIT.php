<?php
/**
 * File for class OvhStructResellerDomainCreateIT
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructResellerDomainCreateIT originally named resellerDomainCreateIT
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructResellerDomainCreateIT extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructResellerDomainCreateIT
	 */
