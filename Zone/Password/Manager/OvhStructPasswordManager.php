<?php
/**
 * File for class OvhStructPasswordManager
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructPasswordManager originally named passwordManager
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructPasswordManager extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructPasswordManager
	 */
