<?php
/**
 * File for class OvhStructSubDomainStruct
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructSubDomainStruct originally named subDomainStruct
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructSubDomainStruct extends OvhWsdlClass
{
	/**
	 * The subdomain
	 * @var string
