<?php
/**
 * File for class OvhStructEmailDomainListByMasterNicResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructEmailDomainListByMasterNicResponse originally named emailDomainListByMasterNicResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructEmailDomainListByMasterNicResponse extends OvhWsdlClass
{
	/**
	 * The return
