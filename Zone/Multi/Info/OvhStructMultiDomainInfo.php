<?php
/**
 * File for class OvhStructMultiDomainInfo
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMultiDomainInfo originally named multiDomainInfo
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMultiDomainInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructMultiDomainInfo
	 */
