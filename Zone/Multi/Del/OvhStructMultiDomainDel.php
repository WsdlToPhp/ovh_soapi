<?php
/**
 * File for class OvhStructMultiDomainDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMultiDomainDel originally named multiDomainDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMultiDomainDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructMultiDomainDel
	 */
