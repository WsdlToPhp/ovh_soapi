<?php
/**
 * File for class OvhStructMultiFtpChangePassword
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMultiFtpChangePassword originally named multiFtpChangePassword
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMultiFtpChangePassword extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructMultiFtpChangePassword
	 */
