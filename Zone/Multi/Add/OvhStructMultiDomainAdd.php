<?php
/**
 * File for class OvhStructMultiDomainAdd
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMultiDomainAdd originally named multiDomainAdd
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMultiDomainAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $ownLog;
	/**
	 * Constructor method for multiDomainAdd
	 ...
	 * @return OvhStructMultiDomainAdd
	 */
