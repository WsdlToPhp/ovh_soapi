<?php
/**
 * File for class OvhStructServiceGroupListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructServiceGroupListResponse originally named serviceGroupListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructServiceGroupListResponse extends OvhWsdlClass
{
	/**
	 * The return
