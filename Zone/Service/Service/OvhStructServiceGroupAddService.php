<?php
/**
 * File for class OvhStructServiceGroupAddService
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructServiceGroupAddService originally named serviceGroupAddService
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructServiceGroupAddService extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructServiceGroupAddService
	 */
