<?php
/**
 * File for class OvhStructTicketReopen
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTicketReopen originally named ticketReopen
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTicketReopen extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
