<?php
/**
 * File for class OvhStructPopAttachMasterNic
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructPopAttachMasterNic originally named popAttachMasterNic
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructPopAttachMasterNic extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_pop
	 * @param string $_nic
	 * @return OvhStructPopAttachMasterNic
	 */
