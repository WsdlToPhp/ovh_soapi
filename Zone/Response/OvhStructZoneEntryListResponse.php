<?php
/**
 * File for class OvhStructZoneEntryListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructZoneEntryListResponse originally named zoneEntryListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructZoneEntryListResponse extends OvhWsdlClass
{
	/**
	 * The return
