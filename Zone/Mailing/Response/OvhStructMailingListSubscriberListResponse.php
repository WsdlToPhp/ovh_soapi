<?php
/**
 * File for class OvhStructMailingListSubscriberListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMailingListSubscriberListResponse originally named mailingListSubscriberListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMailingListSubscriberListResponse extends OvhWsdlClass
{
	/**
	 * The return
