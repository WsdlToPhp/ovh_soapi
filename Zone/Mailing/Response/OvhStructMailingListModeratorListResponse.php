<?php
/**
 * File for class OvhStructMailingListModeratorListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMailingListModeratorListResponse originally named mailingListModeratorListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMailingListModeratorListResponse extends OvhWsdlClass
{
	/**
	 * The return
