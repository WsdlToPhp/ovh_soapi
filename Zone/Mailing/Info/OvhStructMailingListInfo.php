<?php
/**
 * File for class OvhStructMailingListInfo
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMailingListInfo originally named mailingListInfo
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMailingListInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_ml
	 * @return OvhStructMailingListInfo
	 */
