<?php
/**
 * File for class OvhStructRipeDeleteOrganisationResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructRipeDeleteOrganisationResponse originally named ripeDeleteOrganisationResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructRipeDeleteOrganisationResponse extends OvhWsdlClass
{
	/**
	 * The return
