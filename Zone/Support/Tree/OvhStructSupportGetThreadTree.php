<?php
/**
 * File for class OvhStructSupportGetThreadTree
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructSupportGetThreadTree originally named supportGetThreadTree
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructSupportGetThreadTree extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param int $_threadId
	 * @return OvhStructSupportGetThreadTree
	 */
