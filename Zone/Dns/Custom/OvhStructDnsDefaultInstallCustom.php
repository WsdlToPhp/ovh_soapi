<?php
/**
 * File for class OvhStructDnsDefaultInstallCustom
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDnsDefaultInstallCustom originally named dnsDefaultInstallCustom
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDnsDefaultInstallCustom extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDnsDefaultInstallCustom
	 */
