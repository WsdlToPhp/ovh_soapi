<?php
/**
 * File for class OvhStructAccountAlertThresholdSet
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructAccountAlertThresholdSet originally named accountAlertThresholdSet
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructAccountAlertThresholdSet extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructAccountAlertThresholdSet
	 */
