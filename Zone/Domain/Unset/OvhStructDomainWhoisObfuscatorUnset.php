<?php
/**
 * File for class OvhStructDomainWhoisObfuscatorUnset
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDomainWhoisObfuscatorUnset originally named domainWhoisObfuscatorUnset
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDomainWhoisObfuscatorUnset extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_field
	 * @return OvhStructDomainWhoisObfuscatorUnset
	 */
