<?php
/**
 * File for class OvhStructOrderEmailMxPlan
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructOrderEmailMxPlan originally named orderEmailMxPlan
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructOrderEmailMxPlan extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructOrderEmailMxPlan
	 */
