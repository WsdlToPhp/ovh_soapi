<?php
/**
 * File for class OvhStructOrderAccountCreditResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructOrderAccountCreditResponse originally named orderAccountCreditResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructOrderAccountCreditResponse extends OvhWsdlClass
{
	/**
	 * The return
