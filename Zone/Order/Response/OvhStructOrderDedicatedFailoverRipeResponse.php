<?php
/**
 * File for class OvhStructOrderDedicatedFailoverRipeResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructOrderDedicatedFailoverRipeResponse originally named orderDedicatedFailoverRipeResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructOrderDedicatedFailoverRipeResponse extends OvhWsdlClass
{
	/**
	 * The return
