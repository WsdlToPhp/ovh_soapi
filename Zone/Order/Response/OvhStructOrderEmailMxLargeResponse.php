<?php
/**
 * File for class OvhStructOrderEmailMxLargeResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructOrderEmailMxLargeResponse originally named orderEmailMxLargeResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructOrderEmailMxLargeResponse extends OvhWsdlClass
{
	/**
	 * The return
