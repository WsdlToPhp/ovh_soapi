<?php
/**
 * File for class OvhStructSqlpriveMysqlVersion
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructSqlpriveMysqlVersion originally named sqlpriveMysqlVersion
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructSqlpriveMysqlVersion extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructSqlpriveMysqlVersion
	 */
