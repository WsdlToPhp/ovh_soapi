<?php
/**
 * File for class OvhStructSqlpriveMysqlGetPossibleDump
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructSqlpriveMysqlGetPossibleDump originally named sqlpriveMysqlGetPossibleDump
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructSqlpriveMysqlGetPossibleDump extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructSqlpriveMysqlGetPossibleDump
	 */
