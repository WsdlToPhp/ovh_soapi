<?php
/**
 * File for class OvhStructZoneEntryModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructZoneEntryModify originally named zoneEntryModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructZoneEntryModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_newTarget
	 * @return OvhStructZoneEntryModify
	 */
	...
	/**
	 * Set newTarget value
	 * @param string $_newTarget the newTarget
	 * @return string
	 */
