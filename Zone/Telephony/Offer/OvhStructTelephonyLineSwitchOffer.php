<?php
/**
 * File for class OvhStructTelephonyLineSwitchOffer
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyLineSwitchOffer originally named telephonyLineSwitchOffer
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyLineSwitchOffer extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_offer
	 * @return OvhStructTelephonyLineSwitchOffer
	 */
