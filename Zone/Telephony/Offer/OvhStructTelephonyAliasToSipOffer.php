<?php
/**
 * File for class OvhStructTelephonyAliasToSipOffer
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyAliasToSipOffer originally named telephonyAliasToSipOffer
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyAliasToSipOffer extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyAliasToSipOffer
	 */
