<?php
/**
 * File for class OvhStructTelephonyPortabilityOrderSpecialNumber
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPortabilityOrderSpecialNumber originally named telephonyPortabilityOrderSpecialNumber
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPortabilityOrderSpecialNumber extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
