<?php
/**
 * File for class OvhStructTelephonySmsGetUserQuota
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsGetUserQuota originally named telephonySmsGetUserQuota
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsGetUserQuota extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_login
	 * @return OvhStructTelephonySmsGetUserQuota
	 */
