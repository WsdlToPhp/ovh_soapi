<?php
/**
 * File for class OvhStructTelephonyFreefaxToVoicefaxResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyFreefaxToVoicefaxResponse originally named telephonyFreefaxToVoicefaxResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyFreefaxToVoicefaxResponse extends OvhWsdlClass
{
	/**
	 * The return
