<?php
/**
 * File for class OvhStructTelephonyPhonebookOnSmsListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookOnSmsListResponse originally named telephonyPhonebookOnSmsListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookOnSmsListResponse extends OvhWsdlClass
{
	/**
	 * The return
