<?php
/**
 * File for class OvhStructTelephonyAbbreviatedNumberOnGroupListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyAbbreviatedNumberOnGroupListResponse originally named telephonyAbbreviatedNumberOnGroupListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyAbbreviatedNumberOnGroupListResponse extends OvhWsdlClass
{
	/**
	 * The return
