<?php
/**
 * File for class OvhStructTelephonyHuntingGroupListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyHuntingGroupListResponse originally named telephonyHuntingGroupListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyHuntingGroupListResponse extends OvhWsdlClass
{
	/**
	 * The return
	...
	public $return;
	/**
	 * Constructor method for telephonyHuntingGroupListResponse
