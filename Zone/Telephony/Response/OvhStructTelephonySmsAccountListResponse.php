<?php
/**
 * File for class OvhStructTelephonySmsAccountListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsAccountListResponse originally named telephonySmsAccountListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsAccountListResponse extends OvhWsdlClass
{
	/**
	 * The return
