<?php
/**
 * File for class OvhStructTelephonySpecialNumberOrderResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySpecialNumberOrderResponse originally named telephonySpecialNumberOrderResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySpecialNumberOrderResponse extends OvhWsdlClass
{
	/**
	 * The return
