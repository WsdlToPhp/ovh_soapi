<?php
/**
 * File for class OvhStructTelephonySmsListCsvAttachmentResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsListCsvAttachmentResponse originally named telephonySmsListCsvAttachmentResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsListCsvAttachmentResponse extends OvhWsdlClass
{
	/**
	 * The return
