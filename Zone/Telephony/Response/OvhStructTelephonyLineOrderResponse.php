<?php
/**
 * File for class OvhStructTelephonyLineOrderResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyLineOrderResponse originally named telephonyLineOrderResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyLineOrderResponse extends OvhWsdlClass
{
	/**
	 * The return
