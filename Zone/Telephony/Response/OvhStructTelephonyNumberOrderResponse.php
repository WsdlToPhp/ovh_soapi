<?php
/**
 * File for class OvhStructTelephonyNumberOrderResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyNumberOrderResponse originally named telephonyNumberOrderResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyNumberOrderResponse extends OvhWsdlClass
{
	/**
	 * The return
