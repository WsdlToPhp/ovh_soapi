<?php
/**
 * File for class OvhStructTelephonyBillDetails
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyBillDetails originally named telephonyBillDetails
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyBillDetails extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_date
	 * @return OvhStructTelephonyBillDetails
	 */
