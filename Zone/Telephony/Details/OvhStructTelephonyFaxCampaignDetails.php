<?php
/**
 * File for class OvhStructTelephonyFaxCampaignDetails
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyFaxCampaignDetails originally named telephonyFaxCampaignDetails
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyFaxCampaignDetails extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for telephonyFaxCampaignDetails
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_number
	 * @param string $_country
	 * @param string $_reference
	 * @param boolean $_sendRecipients
	 * @return OvhStructTelephonyFaxCampaignDetails
	 */
	 ...
	 * @param boolean $_sendRecipients the sendRecipients
	 * @return boolean
	 */
