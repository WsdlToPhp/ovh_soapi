<?php
/**
 * File for class OvhStructTelephonyClick2CallUserDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyClick2CallUserDel originally named telephonyClick2CallUserDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyClick2CallUserDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_login
	 * @return OvhStructTelephonyClick2CallUserDel
	 */
