<?php
/**
 * File for class OvhStructTelephonyTrunkExternalDisplayedNumberCheck
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyTrunkExternalDisplayedNumberCheck originally named telephonyTrunkExternalDisplayedNumberCheck
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyTrunkExternalDisplayedNumberCheck extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyTrunkExternalDisplayedNumberCheck
	 */
