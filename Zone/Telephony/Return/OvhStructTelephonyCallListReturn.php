<?php
/**
 * File for class OvhStructTelephonyCallListReturn
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyCallListReturn originally named telephonyCallListReturn
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyCallListReturn extends OvhWsdlClass
{
	/**
	 * The fromDate
	 * @var string
