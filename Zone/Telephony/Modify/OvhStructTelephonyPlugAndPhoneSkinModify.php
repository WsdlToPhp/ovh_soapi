<?php
/**
 * File for class OvhStructTelephonyPlugAndPhoneSkinModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPlugAndPhoneSkinModify originally named telephonyPlugAndPhoneSkinModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPlugAndPhoneSkinModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_skin
	 * @return OvhStructTelephonyPlugAndPhoneSkinModify
	 */
