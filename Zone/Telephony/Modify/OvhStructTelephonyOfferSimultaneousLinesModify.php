<?php
/**
 * File for class OvhStructTelephonyOfferSimultaneousLinesModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyOfferSimultaneousLinesModify originally named telephonyOfferSimultaneousLinesModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyOfferSimultaneousLinesModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyOfferSimultaneousLinesModify
	 */
