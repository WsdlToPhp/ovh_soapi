<?php
/**
 * File for class OvhStructTelephonyPhonebookContactModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookContactModify originally named telephonyPhonebookContactModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookContactModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_group
	 * @return OvhStructTelephonyPhonebookContactModify
	 */
