<?php
/**
 * File for class OvhStructTelephonyPhonebookOnSmsContactModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookOnSmsContactModify originally named telephonyPhonebookOnSmsContactModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookOnSmsContactModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyPhonebookOnSmsContactModify
	 */
