<?php
/**
 * File for class OvhStructTelephonySmsUserPassword
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsUserPassword originally named telephonySmsUserPassword
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsUserPassword extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $password;
	/**
	 * Constructor method for telephonySmsUserPassword
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_smsAccount
	 * @param string $_login
	 * @param string $_password
	 * @return OvhStructTelephonySmsUserPassword
	 */
