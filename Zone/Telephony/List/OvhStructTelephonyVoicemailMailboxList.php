<?php
/**
 * File for class OvhStructTelephonyVoicemailMailboxList
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyVoicemailMailboxList originally named telephonyVoicemailMailboxList
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyVoicemailMailboxList extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $sortOrder;
	/**
	 * Constructor method for telephonyVoicemailMailboxList
	 ...
	 * @return OvhStructTelephonyVoicemailMailboxList
	 */
