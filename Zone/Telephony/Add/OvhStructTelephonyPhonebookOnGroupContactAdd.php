<?php
/**
 * File for class OvhStructTelephonyPhonebookOnGroupContactAdd
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookOnGroupContactAdd originally named telephonyPhonebookOnGroupContactAdd
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookOnGroupContactAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyPhonebookOnGroupContactAdd
	 */
