<?php
/**
 * File for class OvhStructTelephonyAbbreviatedNumberAdd
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyAbbreviatedNumberAdd originally named telephonyAbbreviatedNumberAdd
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyAbbreviatedNumberAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyAbbreviatedNumberAdd
	 */
