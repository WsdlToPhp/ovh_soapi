<?php
/**
 * File for class OvhStructTelephonyPhonebookContactAdd
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookContactAdd originally named telephonyPhonebookContactAdd
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookContactAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $group;
	/**
	 * Constructor method for telephonyPhonebookContactAdd
	 ...
	 * @param string $_group
	 * @return OvhStructTelephonyPhonebookContactAdd
	 */
