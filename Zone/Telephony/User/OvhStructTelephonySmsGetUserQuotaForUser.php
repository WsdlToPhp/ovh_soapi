<?php
/**
 * File for class OvhStructTelephonySmsGetUserQuotaForUser
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsGetUserQuotaForUser originally named telephonySmsGetUserQuotaForUser
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsGetUserQuotaForUser extends OvhWsdlClass
{
	/**
	 * The smsAccount
	 * Meta informations extracted from the WSDL
	...
	public $password;
	/**
	 * Constructor method for telephonySmsGetUserQuotaForUser
	 * @see parent::__construct()
	 * @param string $_smsAccount
	 * @param string $_login
	 * @param string $_password
	 * @return OvhStructTelephonySmsGetUserQuotaForUser
	 */
