<?php
/**
 * File for class OvhStructTelephonySmsDeleteCsvAttachment
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsDeleteCsvAttachment originally named telephonySmsDeleteCsvAttachment
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsDeleteCsvAttachment extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySmsDeleteCsvAttachment
	 */
