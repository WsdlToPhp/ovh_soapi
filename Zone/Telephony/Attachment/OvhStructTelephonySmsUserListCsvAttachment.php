<?php
/**
 * File for class OvhStructTelephonySmsUserListCsvAttachment
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsUserListCsvAttachment originally named telephonySmsUserListCsvAttachment
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsUserListCsvAttachment extends OvhWsdlClass
{
	/**
	 * The smsAccount
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_id
	 * @return OvhStructTelephonySmsUserListCsvAttachment
	 */
