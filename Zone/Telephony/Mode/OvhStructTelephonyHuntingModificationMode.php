<?php
/**
 * File for class OvhStructTelephonyHuntingModificationMode
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyHuntingModificationMode originally named telephonyHuntingModificationMode
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyHuntingModificationMode extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyHuntingModificationMode
	 */
