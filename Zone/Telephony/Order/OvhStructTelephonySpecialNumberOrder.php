<?php
/**
 * File for class OvhStructTelephonySpecialNumberOrder
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySpecialNumberOrder originally named telephonySpecialNumberOrder
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySpecialNumberOrder extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySpecialNumberOrder
	 */
	public function __construct($_session = NULL,$_billingAccount = NULL,$_country = NULL,$_aliasNumber = NULL,$_prefix = NULL,$_category = NULL,$_numberToReserve = NULL,$_name = NULL,$_firstname = NULL,$_streetName = NULL,$_streetNumber = NULL,$_zip = NULL,$_city = NULL,$_email = NULL,$_procedureId = NULL,$_legalForm = NULL,$_siret = NULL,$_ape = NULL,$_socialNomination = NULL,$_displayUniversalDirectory = NULL,$_retractation = NULL)
	{
		parent::__construct(array('session'=>$_session,'billingAccount'=>$_billingAccount,'country'=>$_country,'aliasNumber'=>$_aliasNumber,'prefix'=>$_prefix,'category'=>$_category,'numberToReserve'=>$_numberToReserve,'name'=>$_name,'firstname'=>$_firstname,'streetName'=>$_streetName,'streetNumber'=>$_streetNumber,'zip'=>$_zip,'city'=>$_city,'email'=>$_email,'procedureId'=>$_procedureId,'legalForm'=>$_legalForm,'siret'=>$_siret,'ape'=>$_ape,'socialNomination'=>$_socialNomination,'displayUniversalDirectory'=>$_displayUniversalDirectory,'retractation'=>$_retractation));
	}
	/**
	 * Get session value
	 * @return string|null
