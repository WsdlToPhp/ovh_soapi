<?php
/**
 * File for class OvhStructTelephonySmsSenderValidate
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsSenderValidate originally named telephonySmsSenderValidate
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsSenderValidate extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param int $_code
	 * @return OvhStructTelephonySmsSenderValidate
	 */
