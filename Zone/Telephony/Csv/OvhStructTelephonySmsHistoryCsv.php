<?php
/**
 * File for class OvhStructTelephonySmsHistoryCsv
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsHistoryCsv originally named telephonySmsHistoryCsv
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsHistoryCsv extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySmsHistoryCsv
	 */
	public function __construct($_session = NULL,$_smsAccount = NULL,$_smsId = NULL,$_user = NULL,$_pagingStart = NULL,$_pagingLimit = NULL,$_sortField = NULL,$_sortOrder = NULL,$_tag = NULL,$_filter = NULL)
	{
		parent::__construct(array('session'=>$_session,'smsAccount'=>$_smsAccount,'smsId'=>$_smsId,'user'=>$_user,'pagingStart'=>$_pagingStart,'pagingLimit'=>$_pagingLimit,'sortField'=>$_sortField,'sortOrder'=>$_sortOrder,'tag'=>$_tag,'filter'=>$_filter));
	}
	/**
	 * Get session value
	 * @return string|null
