<?php
/**
 * File for class OvhStructPrepaidDomainRenew
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructPrepaidDomainRenew originally named prepaidDomainRenew
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructPrepaidDomainRenew extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructPrepaidDomainRenew
	 */
