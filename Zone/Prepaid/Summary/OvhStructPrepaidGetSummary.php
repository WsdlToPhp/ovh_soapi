<?php
/**
 * File for class OvhStructPrepaidGetSummary
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructPrepaidGetSummary originally named prepaidGetSummary
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructPrepaidGetSummary extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_nic
	 * @return OvhStructPrepaidGetSummary
	 */
