<?php
/**
 * File for class OvhStructPrepaidDomainCreate
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructPrepaidDomainCreate originally named prepaidDomainCreate
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructPrepaidDomainCreate extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructPrepaidDomainCreate
	 */
