<?php
/**
 * File for class OvhStructNicPublicInfo
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructNicPublicInfo originally named nicPublicInfo
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructNicPublicInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
