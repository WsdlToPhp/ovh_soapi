<?php
/**
 * File for class OvhStructManagedServicesPartitionStatusCheck
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructManagedServicesPartitionStatusCheck originally named managedServicesPartitionStatusCheck
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructManagedServicesPartitionStatusCheck extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructManagedServicesPartitionStatusCheck
	 */
