<?php
/**
 * File for class OvhStructSqlpriveMysqlUserListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructSqlpriveMysqlUserListResponse originally named sqlpriveMysqlUserListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructSqlpriveMysqlUserListResponse extends OvhWsdlClass
{
	/**
	 * The return
