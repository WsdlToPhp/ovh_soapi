<?php
/**
 * File for class OvhStructSqlpriveMysqlDatabaseListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructSqlpriveMysqlDatabaseListResponse originally named sqlpriveMysqlDatabaseListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructSqlpriveMysqlDatabaseListResponse extends OvhWsdlClass
{
	/**
	 * The return
