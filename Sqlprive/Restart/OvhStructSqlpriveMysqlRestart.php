<?php
/**
 * File for class OvhStructSqlpriveMysqlRestart
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructSqlpriveMysqlRestart originally named sqlpriveMysqlRestart
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructSqlpriveMysqlRestart extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructSqlpriveMysqlRestart
	 */
