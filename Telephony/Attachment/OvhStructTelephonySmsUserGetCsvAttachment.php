<?php
/**
 * File for class OvhStructTelephonySmsUserGetCsvAttachment
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsUserGetCsvAttachment originally named telephonySmsUserGetCsvAttachment
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsUserGetCsvAttachment extends OvhWsdlClass
{
	/**
	 * The smsAccount
	 * Meta informations extracted from the WSDL
	...
	public $id;
	/**
	 * Constructor method for telephonySmsUserGetCsvAttachment
	 * @see parent::__construct()
	 * @param string $_smsAccount
	 * @param string $_login
	 * @param string $_password
	 * @param string $_id
	 * @return OvhStructTelephonySmsUserGetCsvAttachment
	 */
