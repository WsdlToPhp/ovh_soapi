<?php
/**
 * File for class OvhStructTelephonyVoicemailMailboxDownloadReturn
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyVoicemailMailboxDownloadReturn originally named telephonyVoicemailMailboxDownloadReturn
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyVoicemailMailboxDownloadReturn extends OvhWsdlClass
{
	/**
	 * The fileName
	 * @var string
