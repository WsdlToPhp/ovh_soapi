<?php
/**
 * File for class OvhStructTelephonyRedirectInfoReturn
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyRedirectInfoReturn originally named telephonyRedirectInfoReturn
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyRedirectInfoReturn extends OvhWsdlClass
{
	/**
	 * The number
	 * @var string
