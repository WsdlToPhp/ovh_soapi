<?php
/**
 * File for class OvhStructTelephonyLineSetMgcpIpRestriction
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyLineSetMgcpIpRestriction originally named telephonyLineSetMgcpIpRestriction
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyLineSetMgcpIpRestriction extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyLineSetMgcpIpRestriction
	 */
