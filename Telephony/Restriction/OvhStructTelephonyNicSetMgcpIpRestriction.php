<?php
/**
 * File for class OvhStructTelephonyNicSetMgcpIpRestriction
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyNicSetMgcpIpRestriction originally named telephonyNicSetMgcpIpRestriction
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyNicSetMgcpIpRestriction extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyNicSetMgcpIpRestriction
	 */
