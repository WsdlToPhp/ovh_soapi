<?php
/**
 * File for class OvhStructTelephonyClick2CallUserAdd
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyClick2CallUserAdd originally named telephonyClick2CallUserAdd
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyClick2CallUserAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyClick2CallUserAdd
	 */
