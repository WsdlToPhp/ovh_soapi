<?php
/**
 * File for class OvhStructTelephonySipToAliasOffer
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySipToAliasOffer originally named telephonySipToAliasOffer
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySipToAliasOffer extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySipToAliasOffer
	 */
	...
	/**
	 * Set delete value
	 * @param boolean $_delete the delete
	 * @return boolean
	 */
