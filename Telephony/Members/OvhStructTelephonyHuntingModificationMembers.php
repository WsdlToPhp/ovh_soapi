<?php
/**
 * File for class OvhStructTelephonyHuntingModificationMembers
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyHuntingModificationMembers originally named telephonyHuntingModificationMembers
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyHuntingModificationMembers extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyHuntingModificationMembers
	 */
