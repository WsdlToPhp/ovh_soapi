<?php
/**
 * File for class OvhStructTelephonySmsUserMultiSend
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsUserMultiSend originally named telephonySmsUserMultiSend
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsUserMultiSend extends OvhWsdlClass
{
	/**
	 * The login
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySmsUserMultiSend
	 */
	public function __construct($_login = NULL,$_password = NULL,$_smsAccount = NULL,$_numberFrom = NULL,$_numberTo = NULL,$_message = NULL,$_smsValidity = NULL,$_smsClass = NULL,$_smsDeferred = NULL,$_smsPriority = NULL,$_smsCoding = NULL,$_tag = NULL,$_numberToCsv = NULL,$_noStop = NULL)
	{
