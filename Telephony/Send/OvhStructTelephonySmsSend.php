<?php
/**
 * File for class OvhStructTelephonySmsSend
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsSend originally named telephonySmsSend
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsSend extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySmsSend
	 */
	public function __construct($_session = NULL,$_smsAccount = NULL,$_numberFrom = NULL,$_numberTo = NULL,$_message = NULL,$_smsValidity = NULL,$_smsClass = NULL,$_smsDeferred = NULL,$_smsPriority = NULL,$_smsCoding = NULL,$_tag = NULL,$_noStop = NULL)
	{
		parent::__construct(array('session'=>$_session,'smsAccount'=>$_smsAccount,'numberFrom'=>$_numberFrom,'numberTo'=>$_numberTo,'message'=>$_message,'smsValidity'=>$_smsValidity,'smsClass'=>$_smsClass,'smsDeferred'=>$_smsDeferred,'smsPriority'=>$_smsPriority,'smsCoding'=>$_smsCoding,'tag'=>$_tag,'noStop'=>$_noStop));
	}
	/**
	 * Get session value
	 * @return string|null
