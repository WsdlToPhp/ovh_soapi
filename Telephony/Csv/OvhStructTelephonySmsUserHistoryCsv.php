<?php
/**
 * File for class OvhStructTelephonySmsUserHistoryCsv
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsUserHistoryCsv originally named telephonySmsUserHistoryCsv
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsUserHistoryCsv extends OvhWsdlClass
{
	/**
	 * The login
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySmsUserHistoryCsv
	 */
