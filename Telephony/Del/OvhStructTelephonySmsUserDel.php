<?php
/**
 * File for class OvhStructTelephonySmsUserDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsUserDel originally named telephonySmsUserDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsUserDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $login;
	/**
	 * Constructor method for telephonySmsUserDel
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_smsAccount
	 * @param string $_login
	 * @return OvhStructTelephonySmsUserDel
	 */
