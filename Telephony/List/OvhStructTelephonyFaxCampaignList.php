<?php
/**
 * File for class OvhStructTelephonyFaxCampaignList
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyFaxCampaignList originally named telephonyFaxCampaignList
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyFaxCampaignList extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyFaxCampaignList
	 */
	public function __construct($_session = NULL,$_number = NULL,$_country = NULL,$_campaignStatus = NULL,$_pagingStart = NULL,$_pagingLimit = NULL,$_sortField = NULL,$_sortOrder = NULL)
	{
		parent::__construct(array('session'=>$_session,'number'=>$_number,'country'=>$_country,'campaignStatus'=>$_campaignStatus,'pagingStart'=>$_pagingStart,'pagingLimit'=>$_pagingLimit,'sortField'=>$_sortField,'sortOrder'=>$_sortOrder));
	}
	/**
	 * Get session value
	 * @return string|null
