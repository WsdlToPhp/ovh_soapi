<?php
/**
 * File for class OvhStructTelephonySmsplusServiceReversableTicketsList
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsplusServiceReversableTicketsList originally named telephonySmsplusServiceReversableTicketsList
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsplusServiceReversableTicketsList extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySmsplusServiceReversableTicketsList
	 */
