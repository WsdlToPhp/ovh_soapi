<?php
/**
 * File for class OvhStructTelephonyLineList
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyLineList originally named telephonyLineList
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyLineList extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for telephonyLineList
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_billingAccount
	 * @return OvhStructTelephonyLineList
	 */
