<?php
/**
 * File for class OvhStructTelephonySmsGetQuotaNotificationForUser
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsGetQuotaNotificationForUser originally named telephonySmsGetQuotaNotificationForUser
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsGetQuotaNotificationForUser extends OvhWsdlClass
{
	/**
	 * The smsAccount
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonySmsGetQuotaNotificationForUser
	 */
