<?php
/**
 * File for class OvhStructTelephonySmsplusServiceDetails
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsplusServiceDetails originally named telephonySmsplusServiceDetails
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsplusServiceDetails extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $keyword;
	/**
	 * Constructor method for telephonySmsplusServiceDetails
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_shortCode
	 * @param string $_keyword
	 * @return OvhStructTelephonySmsplusServiceDetails
	 */
