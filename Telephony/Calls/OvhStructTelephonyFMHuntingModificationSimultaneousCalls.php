<?php
/**
 * File for class OvhStructTelephonyFMHuntingModificationSimultaneousCalls
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyFMHuntingModificationSimultaneousCalls originally named telephonyFMHuntingModificationSimultaneousCalls
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyFMHuntingModificationSimultaneousCalls extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyFMHuntingModificationSimultaneousCalls
	 */
