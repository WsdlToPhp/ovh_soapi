<?php
/**
 * File for class OvhStructTelephonyPlugAndPhoneOperation
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPlugAndPhoneOperation originally named telephonyPlugAndPhoneOperation
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPlugAndPhoneOperation extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyPlugAndPhoneOperation
	 */
