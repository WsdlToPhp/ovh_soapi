<?php
/**
 * File for class OvhStructTelephonyVoicemailMessagesDownload
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyVoicemailMessagesDownload originally named telephonyVoicemailMessagesDownload
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyVoicemailMessagesDownload extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyVoicemailMessagesDownload
	 */
