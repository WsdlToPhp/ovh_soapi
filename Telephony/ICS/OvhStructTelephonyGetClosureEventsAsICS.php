<?php
/**
 * File for class OvhStructTelephonyGetClosureEventsAsICS
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyGetClosureEventsAsICS originally named telephonyGetClosureEventsAsICS
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyGetClosureEventsAsICS extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyGetClosureEventsAsICS
	 */
	public function __construct($_session = NULL,$_number = NULL,$_country = NULL,$_dateStart = NULL,$_dateEnd = NULL,$_categories = NULL)
	{
		parent::__construct(array('session'=>$_session,'number'=>$_number,'country'=>$_country,'dateStart'=>$_dateStart,'dateEnd'=>$_dateEnd,'categories'=>$_categories));
	}
	/**
	 * Get session value
	 * @return string|null
