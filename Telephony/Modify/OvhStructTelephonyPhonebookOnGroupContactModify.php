<?php
/**
 * File for class OvhStructTelephonyPhonebookOnGroupContactModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookOnGroupContactModify originally named telephonyPhonebookOnGroupContactModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookOnGroupContactModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyPhonebookOnGroupContactModify
	 */
