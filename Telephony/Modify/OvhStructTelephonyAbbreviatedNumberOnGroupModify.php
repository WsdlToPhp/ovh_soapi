<?php
/**
 * File for class OvhStructTelephonyAbbreviatedNumberOnGroupModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyAbbreviatedNumberOnGroupModify originally named telephonyAbbreviatedNumberOnGroupModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyAbbreviatedNumberOnGroupModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyAbbreviatedNumberOnGroupModify
	 */
