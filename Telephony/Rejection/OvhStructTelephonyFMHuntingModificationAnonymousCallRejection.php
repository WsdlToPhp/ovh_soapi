<?php
/**
 * File for class OvhStructTelephonyFMHuntingModificationAnonymousCallRejection
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyFMHuntingModificationAnonymousCallRejection originally named telephonyFMHuntingModificationAnonymousCallRejection
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyFMHuntingModificationAnonymousCallRejection extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructTelephonyFMHuntingModificationAnonymousCallRejection
	 */
