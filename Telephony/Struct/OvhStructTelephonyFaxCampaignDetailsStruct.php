<?php
/**
 * File for class OvhStructTelephonyFaxCampaignDetailsStruct
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyFaxCampaignDetailsStruct originally named telephonyFaxCampaignDetailsStruct
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyFaxCampaignDetailsStruct extends OvhWsdlClass
{
	/**
	 * The campaignName
	 * @var string
	...
	/**
	 * The recipients
	 * @var OvhStructMyArrayOfTelephonyRecipientStructType
	 */
	public $recipients;
	/**
	 ...
	 * @param OvhStructMyArrayOfTelephonyRecipientStructType $_recipients
	...
	{
		parent::__construct(array('campaignName'=>$_campaignName,'campaignStatus'=>$_campaignStatus,'dateStart'=>$_dateStart,'dateEnd'=>$_dateEnd,'total'=>$_total,'todo'=>$_todo,'success'=>$_success,'failed'=>$_failed,'reference'=>$_reference,'recipients'=>($_recipients instanceof OvhStructMyArrayOfTelephonyRecipientStructType)?$_recipients:new OvhStructMyArrayOfTelephonyRecipientStructType($_recipients)));
	}
	/**
	 ...
	 * @return OvhStructMyArrayOfTelephonyRecipientStructType|null
	 */
	 ...
	 * @param OvhStructMyArrayOfTelephonyRecipientStructType $_recipients the recipients
	 * @return OvhStructMyArrayOfTelephonyRecipientStructType
	 */
