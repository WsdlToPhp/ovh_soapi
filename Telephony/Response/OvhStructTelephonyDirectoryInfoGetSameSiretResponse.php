<?php
/**
 * File for class OvhStructTelephonyDirectoryInfoGetSameSiretResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyDirectoryInfoGetSameSiretResponse originally named telephonyDirectoryInfoGetSameSiretResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyDirectoryInfoGetSameSiretResponse extends OvhWsdlClass
{
	/**
	 * The return
