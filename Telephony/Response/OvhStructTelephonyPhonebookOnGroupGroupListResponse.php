<?php
/**
 * File for class OvhStructTelephonyPhonebookOnGroupGroupListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookOnGroupGroupListResponse originally named telephonyPhonebookOnGroupGroupListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookOnGroupGroupListResponse extends OvhWsdlClass
{
	/**
	 * The return
