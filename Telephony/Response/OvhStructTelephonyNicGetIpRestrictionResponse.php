<?php
/**
 * File for class OvhStructTelephonyNicGetIpRestrictionResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyNicGetIpRestrictionResponse originally named telephonyNicGetIpRestrictionResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyNicGetIpRestrictionResponse extends OvhWsdlClass
{
	/**
	 * The return
