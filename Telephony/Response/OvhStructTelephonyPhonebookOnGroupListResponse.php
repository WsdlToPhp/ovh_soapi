<?php
/**
 * File for class OvhStructTelephonyPhonebookOnGroupListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookOnGroupListResponse originally named telephonyPhonebookOnGroupListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookOnGroupListResponse extends OvhWsdlClass
{
	/**
	 * The return
