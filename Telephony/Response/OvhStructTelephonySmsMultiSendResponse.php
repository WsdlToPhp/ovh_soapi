<?php
/**
 * File for class OvhStructTelephonySmsMultiSendResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySmsMultiSendResponse originally named telephonySmsMultiSendResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySmsMultiSendResponse extends OvhWsdlClass
{
	/**
	 * The return
