<?php
/**
 * File for class OvhStructTelephonyRestrictionListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyRestrictionListResponse originally named telephonyRestrictionListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyRestrictionListResponse extends OvhWsdlClass
{
	/**
	 * The return
