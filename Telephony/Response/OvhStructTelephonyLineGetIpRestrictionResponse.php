<?php
/**
 * File for class OvhStructTelephonyLineGetIpRestrictionResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyLineGetIpRestrictionResponse originally named telephonyLineGetIpRestrictionResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyLineGetIpRestrictionResponse extends OvhWsdlClass
{
	/**
	 * The return
