<?php
/**
 * File for class OvhStructTelephonyPhonebookOnSmsContactListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyPhonebookOnSmsContactListResponse originally named telephonyPhonebookOnSmsContactListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyPhonebookOnSmsContactListResponse extends OvhWsdlClass
{
	/**
	 * The return
