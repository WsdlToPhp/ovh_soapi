<?php
/**
 * File for class OvhStructTelephonySparePurchaseResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonySparePurchaseResponse originally named telephonySparePurchaseResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonySparePurchaseResponse extends OvhWsdlClass
{
	/**
	 * The return
