<?php
/**
 * File for class OvhStructTelephonyFaxHistory
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTelephonyFaxHistory originally named telephonyFaxHistory
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTelephonyFaxHistory extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_state
	 * @return OvhStructTelephonyFaxHistory
	 */
