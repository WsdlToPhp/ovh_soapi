<?php
/**
 * File for class OvhStructTicketGet
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTicketGet originally named ticketGet
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTicketGet extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
