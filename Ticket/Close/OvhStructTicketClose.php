<?php
/**
 * File for class OvhStructTicketClose
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructTicketClose originally named ticketClose
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructTicketClose extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
