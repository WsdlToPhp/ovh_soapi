<?php
/**
 * File for class OvhStructServiceGroupCreate
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructServiceGroupCreate originally named serviceGroupCreate
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructServiceGroupCreate extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructServiceGroupCreate
	 */
