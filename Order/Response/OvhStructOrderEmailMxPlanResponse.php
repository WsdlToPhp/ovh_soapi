<?php
/**
 * File for class OvhStructOrderEmailMxPlanResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructOrderEmailMxPlanResponse originally named orderEmailMxPlanResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructOrderEmailMxPlanResponse extends OvhWsdlClass
{
	/**
	 * The return
