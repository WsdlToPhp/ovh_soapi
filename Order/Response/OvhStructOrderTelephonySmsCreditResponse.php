<?php
/**
 * File for class OvhStructOrderTelephonySmsCreditResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructOrderTelephonySmsCreditResponse originally named orderTelephonySmsCreditResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructOrderTelephonySmsCreditResponse extends OvhWsdlClass
{
	/**
	 * The return
