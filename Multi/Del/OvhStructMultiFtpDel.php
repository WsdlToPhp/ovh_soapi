<?php
/**
 * File for class OvhStructMultiFtpDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMultiFtpDel originally named multiFtpDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMultiFtpDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
