<?php
/**
 * File for class OvhStructOrtDomainDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructOrtDomainDel originally named ortDomainDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructOrtDomainDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
