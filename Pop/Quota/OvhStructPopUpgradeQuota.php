<?php
/**
 * File for class OvhStructPopUpgradeQuota
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructPopUpgradeQuota originally named popUpgradeQuota
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructPopUpgradeQuota extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_pop
	 * @param int $_size
	 * @return OvhStructPopUpgradeQuota
	 */
