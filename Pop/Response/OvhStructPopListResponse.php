<?php
/**
 * File for class OvhStructPopListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructPopListResponse originally named popListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructPopListResponse extends OvhWsdlClass
{
	/**
	 * The return
