<?php
/**
 * File for class OvhStructManagedServicesPartitionDelete
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructManagedServicesPartitionDelete originally named managedServicesPartitionDelete
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructManagedServicesPartitionDelete extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_name
	 * @return OvhStructManagedServicesPartitionDelete
	 */
