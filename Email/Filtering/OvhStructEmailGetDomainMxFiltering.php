<?php
/**
 * File for class OvhStructEmailGetDomainMxFiltering
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructEmailGetDomainMxFiltering originally named emailGetDomainMxFiltering
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructEmailGetDomainMxFiltering extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructEmailGetDomainMxFiltering
	 */
