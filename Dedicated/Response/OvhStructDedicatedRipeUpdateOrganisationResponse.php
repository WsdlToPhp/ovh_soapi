<?php
/**
 * File for class OvhStructDedicatedRipeUpdateOrganisationResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedRipeUpdateOrganisationResponse originally named dedicatedRipeUpdateOrganisationResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedRipeUpdateOrganisationResponse extends OvhWsdlClass
{
	/**
	 * The return
