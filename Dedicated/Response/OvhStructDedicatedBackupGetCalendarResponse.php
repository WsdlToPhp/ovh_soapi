<?php
/**
 * File for class OvhStructDedicatedBackupGetCalendarResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedBackupGetCalendarResponse originally named dedicatedBackupGetCalendarResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedBackupGetCalendarResponse extends OvhWsdlClass
{
	/**
	 * The return
