<?php
/**
 * File for class OvhStructDedicatedListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedListResponse originally named dedicatedListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedListResponse extends OvhWsdlClass
{
	/**
	 * The return
	...
	public $return;
	/**
	 * Constructor method for dedicatedListResponse
