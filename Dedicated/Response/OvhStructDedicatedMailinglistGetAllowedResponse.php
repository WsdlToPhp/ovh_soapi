<?php
/**
 * File for class OvhStructDedicatedMailinglistGetAllowedResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedMailinglistGetAllowedResponse originally named dedicatedMailinglistGetAllowedResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedMailinglistGetAllowedResponse extends OvhWsdlClass
{
	/**
	 * The return
