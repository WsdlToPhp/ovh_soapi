<?php
/**
 * File for class OvhStructDedicatedGetAvailableNetworkFromCountryResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedGetAvailableNetworkFromCountryResponse originally named dedicatedGetAvailableNetworkFromCountryResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedGetAvailableNetworkFromCountryResponse extends OvhWsdlClass
{
	/**
	 * The return
