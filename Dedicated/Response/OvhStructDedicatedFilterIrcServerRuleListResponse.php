<?php
/**
 * File for class OvhStructDedicatedFilterIrcServerRuleListResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedFilterIrcServerRuleListResponse originally named dedicatedFilterIrcServerRuleListResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedFilterIrcServerRuleListResponse extends OvhWsdlClass
{
	/**
	 * The return
