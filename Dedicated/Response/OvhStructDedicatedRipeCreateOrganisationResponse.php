<?php
/**
 * File for class OvhStructDedicatedRipeCreateOrganisationResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedRipeCreateOrganisationResponse originally named dedicatedRipeCreateOrganisationResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedRipeCreateOrganisationResponse extends OvhWsdlClass
{
	/**
	 * The return
