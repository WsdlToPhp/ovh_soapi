<?php
/**
 * File for class OvhStructDedicatedRipeGetRipeIdsResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedRipeGetRipeIdsResponse originally named dedicatedRipeGetRipeIdsResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedRipeGetRipeIdsResponse extends OvhWsdlClass
{
	/**
	 * The return
