<?php
/**
 * File for class OvhStructDedicatedNetbootGetAllResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedNetbootGetAllResponse originally named dedicatedNetbootGetAllResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedNetbootGetAllResponse extends OvhWsdlClass
{
	/**
	 * The return
