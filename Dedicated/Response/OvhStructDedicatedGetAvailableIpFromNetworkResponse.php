<?php
/**
 * File for class OvhStructDedicatedGetAvailableIpFromNetworkResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedGetAvailableIpFromNetworkResponse originally named dedicatedGetAvailableIpFromNetworkResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedGetAvailableIpFromNetworkResponse extends OvhWsdlClass
{
	/**
	 * The return
