<?php
/**
 * File for class OvhStructDedicatedInstallationTemplateUse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedInstallationTemplateUse originally named dedicatedInstallationTemplateUse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedInstallationTemplateUse extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDedicatedInstallationTemplateUse
	 */
	...
	/**
	 * Set template value
	 * @param string $_template the template
	 * @return string
	 */
