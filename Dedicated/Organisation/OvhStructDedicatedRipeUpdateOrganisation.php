<?php
/**
 * File for class OvhStructDedicatedRipeUpdateOrganisation
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedRipeUpdateOrganisation originally named dedicatedRipeUpdateOrganisation
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedRipeUpdateOrganisation extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDedicatedRipeUpdateOrganisation
	 */
