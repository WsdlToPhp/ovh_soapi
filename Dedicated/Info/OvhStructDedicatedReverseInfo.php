<?php
/**
 * File for class OvhStructDedicatedReverseInfo
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedReverseInfo originally named dedicatedReverseInfo
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedReverseInfo extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_ip
	 * @return OvhStructDedicatedReverseInfo
	 */
