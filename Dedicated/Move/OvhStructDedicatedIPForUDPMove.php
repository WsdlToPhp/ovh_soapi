<?php
/**
 * File for class OvhStructDedicatedIPForUDPMove
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedIPForUDPMove originally named dedicatedIPForUDPMove
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedIPForUDPMove extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_hostnameTo
	 * @param string $_ip
	 * @return OvhStructDedicatedIPForUDPMove
	 */
	 ...
	 * @param string $_hostnameTo the hostnameTo
	 * @return string
	 */
