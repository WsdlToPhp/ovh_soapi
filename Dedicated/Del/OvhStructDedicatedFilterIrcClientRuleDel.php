<?php
/**
 * File for class OvhStructDedicatedFilterIrcClientRuleDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedFilterIrcClientRuleDel originally named dedicatedFilterIrcClientRuleDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedFilterIrcClientRuleDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $toIp;
	/**
	 * Constructor method for dedicatedFilterIrcClientRuleDel
	 * @see parent::__construct()
	 * @param string $_session
	 * @param string $_hostname
	 * @param string $_fromIp
	 * @param string $_toIp
	 * @return OvhStructDedicatedFilterIrcClientRuleDel
	 */
