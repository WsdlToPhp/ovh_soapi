<?php
/**
 * File for class OvhStructDedicatedBackupListReturn
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedBackupListReturn originally named dedicatedBackupListReturn
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedBackupListReturn extends OvhWsdlClass
{
	/**
	 * The backupId
	 * @var int
