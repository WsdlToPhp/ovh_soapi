<?php
/**
 * File for class OvhStructDedicatedMonitoringServiceAddNotification
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDedicatedMonitoringServiceAddNotification originally named dedicatedMonitoringServiceAddNotification
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDedicatedMonitoringServiceAddNotification extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_url
	 * @param string $_nicAlert
	 * @return OvhStructDedicatedMonitoringServiceAddNotification
	 */
	...
	/**
	 * Set nicAlert value
	 * @param string $_nicAlert the nicAlert
	 * @return string
	 */
