<?php
/**
 * File for class OvhStructBillingGetAccessByNicResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructBillingGetAccessByNicResponse originally named billingGetAccessByNicResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructBillingGetAccessByNicResponse extends OvhWsdlClass
{
	/**
	 * The return
	...
	public $return;
	/**
	 * Constructor method for billingGetAccessByNicResponse
