<?php
/**
 * File for class OvhStructResponderEmailModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructResponderEmailModify originally named responderEmailModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructResponderEmailModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $nic;
	/**
	 * Constructor method for responderEmailModify
	 ...
	 * @param string $_nic
	 * @return OvhStructResponderEmailModify
	 */
