<?php
/**
 * File for class OvhStructResponderEmailDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructResponderEmailDel originally named responderEmailDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructResponderEmailDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructResponderEmailDel
	 */
