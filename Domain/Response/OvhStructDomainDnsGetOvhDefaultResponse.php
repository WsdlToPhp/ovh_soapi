<?php
/**
 * File for class OvhStructDomainDnsGetOvhDefaultResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDomainDnsGetOvhDefaultResponse originally named domainDnsGetOvhDefaultResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDomainDnsGetOvhDefaultResponse extends OvhWsdlClass
{
	/**
	 * The return
