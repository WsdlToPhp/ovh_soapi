<?php
/**
 * File for class OvhStructDomainResellerSet
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructDomainResellerSet originally named domainResellerSet
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructDomainResellerSet extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructDomainResellerSet
	 */
