<?php
/**
 * File for class OvhStructResellerDomainTransfer
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructResellerDomainTransfer originally named resellerDomainTransfer
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructResellerDomainTransfer extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructResellerDomainTransfer
	 */
	...
	{
		parent::__construct(array('session'=>$_session,'domain'=>$_domain,'authinfo'=>$_authinfo,'hosting'=>$_hosting,'offer'=>$_offer,'profile'=>$_profile,'owo'=>$_owo,'owner'=>$_owner,'admin'=>$_admin,'tech'=>$_tech,'billing'=>$_billing,'dns1'=>$_dns1,'dns2'=>$_dns2,'dns3'=>$_dns3,'dns4'=>$_dns4,'dns5'=>$_dns5,'method'=>$_method,'legalName'=>$_legalName,'legalNumber'=>$_legalNumber,'afnicIdent'=>$_afnicIdent,'birthDate'=>$_birthDate,'birthCity'=>$_birthCity,'birthDepartement'=>$_birthDepartement,'birthCountry'=>$_birthCountry,'dryRun'=>$_dryRun));
	}
	/**
	 * Get session value
	 * @return string|null
