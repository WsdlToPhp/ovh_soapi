<?php
/**
 * File for class OvhStructResellerDomainTransferASIA
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructResellerDomainTransferASIA originally named resellerDomainTransferASIA
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructResellerDomainTransferASIA extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructResellerDomainTransferASIA
	 */
