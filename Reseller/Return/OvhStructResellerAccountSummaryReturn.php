<?php
/**
 * File for class OvhStructResellerAccountSummaryReturn
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructResellerAccountSummaryReturn originally named resellerAccountSummaryReturn
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructResellerAccountSummaryReturn extends OvhWsdlClass
{
	/**
	 * The nic
	 * @var string
	 ...
	 * @return OvhStructResellerAccountSummaryReturn
	 */
