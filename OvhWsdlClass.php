<?php
/**
 * File for OvhWsdlClass to communicate with SOAP service
 * @package Ovh
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
/**
 * OvhWsdlClass to communicate with SOAP service
 * 
 * @package Ovh
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses OvhWsdlClass::setLastError()
	 * @uses OvhWsdlClass::initSoapClient()
	 * @uses OvhWsdlClass::initInternArrayToIterate()
	 * @uses OvhWsdlClass::_set()
	...
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'OvhWsdlClass'))
			{
	 ...
	 * @uses OvhClassMap::classMap()
	 * @uses OvhWsdlClass::getDefaultWsdlOptions()
	 * @uses OvhWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('OvhClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = OvhClassMap::classMap();
	 ...
	 * @uses OvhWsdlClass::WSDL_CACHE_WSDL
	 * @uses OvhWsdlClass::WSDL_COMPRESSION
	 * @uses OvhWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses OvhWsdlClass::WSDL_ENCODING
	 * @uses OvhWsdlClass::WSDL_EXCPTS
	 * @uses OvhWsdlClass::WSDL_FEATURES
	 * @uses OvhWsdlClass::WSDL_LOGIN
	 * @uses OvhWsdlClass::WSDL_PASSWD
	 * @uses OvhWsdlClass::WSDL_SOAP_VERSION
	 * @uses OvhWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses OvhWsdlClass::WSDL_TRACE
	 * @uses OvhWsdlClass::WSDL_TYPEMAP
	 * @uses OvhWsdlClass::WSDL_URL
	 * @uses OvhWsdlClass::WSDL_USER_AGENT
	 * @return array
	 */
	 ...
	 * @uses OvhWsdlClass::getSoapClient()
	 * @uses OvhWsdlClass::getFormatedXml()
	 ...
	 * @uses OvhWsdlClass::getSoapClient()
	 * @uses OvhWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses OvhWsdlClass::getInternArrayToIterate()
	 * @uses OvhWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses OvhWsdlClass::getInternArrayToIterateOffset()
	 * @uses OvhWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses OvhWsdlClass::getInternArrayToIterateOffset()
	 * @uses OvhWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @uses OvhWsdlClass::getAttributeName()
	 * @uses OvhWsdlClass::__toString()
	 * @uses OvhWsdlClass::_set()
	 * @uses OvhWsdlClass::_get()
	 * @uses OvhWsdlClass::setInternArrayToIterate()
	 * @uses OvhWsdlClass::setInternArrayToIterateIsArray()
	 * @uses OvhWsdlClass::setInternArrayToIterateOffset()
