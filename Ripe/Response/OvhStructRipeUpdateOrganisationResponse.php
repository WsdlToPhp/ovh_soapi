<?php
/**
 * File for class OvhStructRipeUpdateOrganisationResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructRipeUpdateOrganisationResponse originally named ripeUpdateOrganisationResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructRipeUpdateOrganisationResponse extends OvhWsdlClass
{
	/**
	 * The return
