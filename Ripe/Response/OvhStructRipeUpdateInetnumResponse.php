<?php
/**
 * File for class OvhStructRipeUpdateInetnumResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructRipeUpdateInetnumResponse originally named ripeUpdateInetnumResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructRipeUpdateInetnumResponse extends OvhWsdlClass
{
	/**
	 * The return
