<?php
/**
 * File for class OvhStructRipeGetRipeIdsResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructRipeGetRipeIdsResponse originally named ripeGetRipeIdsResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructRipeGetRipeIdsResponse extends OvhWsdlClass
{
	/**
	 * The return
