<?php
/**
 * File for class OvhStructRipeCreateOrganisationResponse
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructRipeCreateOrganisationResponse originally named ripeCreateOrganisationResponse
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructRipeCreateOrganisationResponse extends OvhWsdlClass
{
	/**
	 * The return
