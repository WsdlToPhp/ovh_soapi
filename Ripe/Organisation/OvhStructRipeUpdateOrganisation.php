<?php
/**
 * File for class OvhStructRipeUpdateOrganisation
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructRipeUpdateOrganisation originally named ripeUpdateOrganisation
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructRipeUpdateOrganisation extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	public $remarks;
	/**
	 * Constructor method for ripeUpdateOrganisation
	 ...
	 * @return OvhStructRipeUpdateOrganisation
	 */
