<?php
/**
 * File for class OvhStructRipeDeleteOrganisation
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructRipeDeleteOrganisation originally named ripeDeleteOrganisation
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructRipeDeleteOrganisation extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @return OvhStructRipeDeleteOrganisation
	 */
