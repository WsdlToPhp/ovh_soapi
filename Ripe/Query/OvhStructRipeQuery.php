<?php
/**
 * File for class OvhStructRipeQuery
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructRipeQuery originally named ripeQuery
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructRipeQuery extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
