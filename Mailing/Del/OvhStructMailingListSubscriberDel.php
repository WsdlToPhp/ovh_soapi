<?php
/**
 * File for class OvhStructMailingListSubscriberDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMailingListSubscriberDel originally named mailingListSubscriberDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMailingListSubscriberDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_ml
	 * @param string $_email
	 * @return OvhStructMailingListSubscriberDel
	 */
