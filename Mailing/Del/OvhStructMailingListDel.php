<?php
/**
 * File for class OvhStructMailingListDel
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMailingListDel originally named mailingListDel
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMailingListDel extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_ml
	 * @return OvhStructMailingListDel
	 */
