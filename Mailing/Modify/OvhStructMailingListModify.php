<?php
/**
 * File for class OvhStructMailingListModify
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMailingListModify originally named mailingListModify
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMailingListModify extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for mailingListModify
	 ...
	 * @return OvhStructMailingListModify
	 */
