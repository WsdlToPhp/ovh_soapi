<?php
/**
 * File for class OvhStructMailingListModeratorAdd
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMailingListModeratorAdd originally named mailingListModeratorAdd
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMailingListModeratorAdd extends OvhWsdlClass
{
	/**
	 * The session
	 * Meta informations extracted from the WSDL
	 ...
	 * @param string $_ml
	 * @param string $_email
	 * @return OvhStructMailingListModeratorAdd
	 */
