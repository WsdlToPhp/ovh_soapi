<?php
/**
 * File for class OvhStructMailingListStruct
 * @package Ovh
 * @subpackage Structs
 * @date 2013-09-04
 ...
 */
/**
 * This class stands for OvhStructMailingListStruct originally named mailingListStruct
 ...
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 */
class OvhStructMailingListStruct extends OvhWsdlClass
{
	/**
	 * The domain
	 * @var string
